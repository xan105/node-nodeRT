...
const namespace = {
  //📖 https://learn.microsoft.com/en-us/uwp/api/windows.applicationmodel.extendedexecution.foreground
  name: "windows.applicationmodel.extendedexecution.foreground",
  externalReference: [
  ]
};
