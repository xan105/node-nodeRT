  ...
  export class KnownSmartCardAppletIds {
    static paymentSystemEnvironment: Object;
    static proximityPaymentSystemEnvironment: Object;
    constructor();
  ...
  export class SmartCardAppletIdGroup {
    ...
    appletIds: Object;
    secureUserAuthenticationRequired: Boolean;
    logo: Object;
    description: String;
    properties: Object;
    constructor();
  ...
  export class SmartCardAppletIdGroupRegistration {
    ...
    setPropertiesAsync(props: Object, callback: (error: Error) => void): void ;
