  ...
  export enum ESimDiscoverResultKind {
    none,
    events,
    profileMetadata,
  }
  ...
  export enum MobileBroadbandSlotState {
    unmanaged,
    unknown,
    offEmpty,
    off,
  ...
  export class ESim {
    ...
    discoverAsync(callback: (error: Error, result: ESimDiscoverResult) => void): void ;
    discoverAsync(serverAddress: String, matchingId: String, callback: (error: Error, result: ESimDiscoverResult) => void): void ;

    getProfiles(): Object;

    discover(): ESimDiscoverResult;
    discover(serverAddress: String, matchingId: String): ESimDiscoverResult;
  ...
  export class ESimDiscoverEvent {
    matchingId: String;
  ...
  export class ESimDiscoverResult {
    events: Object;
  ...
  export class MobileBroadbandCellNR {
    cellId: Number;
    channelNumber: Number;
    physicalCellId: Number;
    providerId: String;
    ...
    timingAdvanceInNanoseconds: Number;
    trackingAreaCode: Number;
    constructor();
  ...
  export class MobileBroadbandCellsInfo {
    ...
    neighboringCellsNR: Object;
    servingCellsNR: Object;
    constructor();

  }

  export class MobileBroadbandCurrentSlotIndexChangedEventArgs {
  ...
  export class MobileBroadbandDeviceInformation {
    ...
    simPnn: String;
    simSpn: String;
    slotManager: MobileBroadbandSlotManager;
    constructor();
  ...
  export class MobileBroadbandModem {
    ...
    getIsPassthroughEnabledAsync(slotindex: Number, callback: (error: Error, result: Boolean) => void): void ;

    setIsPassthroughEnabledAsync(value: Boolean, callback: (error: Error, result: MobileBroadbandModemStatus) => void): void ;
    setIsPassthroughEnabledAsync(value: Boolean, slotindex: Number, callback: (error: Error, result: MobileBroadbandModemStatus) => void): void ;
    ...
    setIsPassthroughEnabled(value: Boolean, slotindex: Number): MobileBroadbandModemStatus;

    getIsPassthroughEnabled(slotindex: Number): Boolean;
  ...
  export class MobileBroadbandSlotInfo {
    index: Number;
  ...
  export class MobileBroadbandSlotInfoChangedEventArgs {
    slotInfo: MobileBroadbandSlotInfo;
    constructor();

  }

  export class MobileBroadbandSlotManager {
    currentSlotIndex: Number;
    slotInfos: Object;
    constructor();

    setCurrentSlotAsync(slotIndex: Number, callback: (error: Error, result: MobileBroadbandModemStatus) => void): void ;

    setCurrentSlot(slotIndex: Number): MobileBroadbandModemStatus;

    addListener(type: "CurrentSlotIndexChanged", listener: (ev: Event) => void): void ;
    removeListener(type: "CurrentSlotIndexChanged", listener: (ev: Event) => void): void ;
    on(type: "CurrentSlotIndexChanged", listener: (ev: Event) => void): void ;
    off(type: "CurrentSlotIndexChanged", listener: (ev: Event) => void): void ;
    
    addListener(type: "SlotInfoChanged", listener: (ev: Event) => void): void ;
    removeListener(type: "SlotInfoChanged", listener: (ev: Event) => void): void ;
    on(type: "SlotInfoChanged", listener: (ev: Event) => void): void ;
    off(type: "SlotInfoChanged", listener: (ev: Event) => void): void ;
  ...
  export class NetworkOperatorTetheringAccessPointConfiguration {
    ...
    isBandSupportedAsync(band: TetheringWiFiBand, callback: (error: Error, result: Boolean) => void): void ;

    isBandSupported(band: TetheringWiFiBand): Boolean;
  ...
  export class NetworkOperatorTetheringManager {
    ...
    static enableNoConnectionsTimeoutAsync(callback: (error: Error) => void): void ;


    static disableNoConnectionsTimeoutAsync(callback: (error: Error) => void): void ;


    static isNoConnectionsTimeoutEnabled(): Boolean;


    static enableNoConnectionsTimeout(): void;


    static disableNoConnectionsTimeout(): void;
